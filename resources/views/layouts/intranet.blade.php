                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            <li class="nav-item right-side-toggle" @click="ubicacion=0"> <a class="nav-link dropdown-toggle waves-effect waves-dark" aria-expanded="false"><i class="fa fa-file-text"></i><span class="hide-menu"> Pagina</span></a></li>
