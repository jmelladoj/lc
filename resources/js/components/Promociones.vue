            ...
            <b-row class="page-titles">
                ...
                <b-col cols="7">
                    <div class="d-flex justify-content-end align-items-right">
                        ...
                        <b-button v-if="tipo_usuario < 3" @click="abrirModal(1)" class="btn btn-info d-lg-block m-l-15" v-b-tooltip.hover title="Agrega una promoción a la plataforma"><i class="fa fa-plus-circle"></i> Agregar Promoción</b-button>
                    </div>                    
                </b-col>
            </b-row>
