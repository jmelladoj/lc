                        ...
                        <form>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 d-flex align-items-center justify-content-center">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="estudiante" name="tipo_persona" v-model="usuario_nuevo.tipo_persona" class="custom-control-input" value="3">
                                            <label class="custom-control-label" for="estudiante"> Estudiante</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 d-flex align-items-center justify-content-center">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="persona" name="tipo_persona" v-model="usuario_nuevo.tipo_persona" class="custom-control-input" value="1">
                                            <label class="custom-control-label" for="persona"> Prevencionista</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 d-flex align-items-center justify-content-center">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="empresa" name="tipo_persona" v-model="usuario_nuevo.tipo_persona" class="custom-control-input" value="2">
                            ...
                            <p class="form-field-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <input class="input--lg form-full" v-model="usuario_nuevo.email" type="email" placeholder="Correo electrónico" required>
                                    </div>
                                </div>
                            </p>
                            <p class="form-field-wrapper">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <input class="input--lg form-full" v-model="usuario_nuevo.clave_uno" type="password" placeholder="Crea tu clave (6 caracteres)" required>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <input class="input--lg form-full" v-model="usuario_nuevo.clave_dos" type="password" placeholder="Repite esa clave" required>
                                    </div>
                                </div>
                            </p>
