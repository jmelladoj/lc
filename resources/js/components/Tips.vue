            ...
            <b-row class="page-titles">
                ...
                <b-col cols="7">
                    <div class="d-flex justify-content-end align-items-right">
                        ...
                        <b-button @click="abrirModal(1)" class="btn btn-info d-lg-block m-l-15" v-b-tooltip.hover title="Agrega un tip a la plataforma"><i class="fa fa-plus-circle"></i> Agregar Tip</b-button>
                    </div>                    
                </b-col>
            </b-row>
