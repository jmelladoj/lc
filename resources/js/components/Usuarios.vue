            ...
            <b-row class="page-titles">
                ...
                <b-col cols="7">
                    <div class="d-flex justify-content-end align-items-right">
                        ...
                        <b-button @click="abrirModal(1)" class="btn btn-info d-lg-block m-l-15" v-b-tooltip title="Agrega un usuario a la plataforma"><i class="fa fa-plus-circle"></i> Agregar Usuario</b-button>
                    </div>                    
                </b-col>
            </b-row>
                            ...
                            <b-col>
                                <b-form-group label="Tipo de usuario">
                                    <ValidationProvider name="tipo de usuario" rules="required|oneOf:1,2,3" v-slot="{ errors }">
                                        <b-form-select v-model="usuario.tipo_usuario" class="mb-3">
