    ...
    public function index($tipo){  
        switch ($tipo) {
            case 1:
                ...
                break;
            case 2:
                return ['promociones' => Promocion::where('fecha', '>=', Carbon::now()->format('Y-m-d'))->where('categorias_usuarios_id', null)->orWhere('categorias_usuarios_id', Auth::user()->categoria->id)->orderBy('fecha', 'desc')->get()];
                break;
        }
    }
